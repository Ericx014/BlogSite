...
{
    /// <inheritdoc />
    public partial class ChangedBlogDislikedName : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogDislikes", x => new { x.BlogId, x.UserId });
                    table.ForeignKey(
                        name: "FK_BlogDislikes_Blogs_BlogId",
                        column: x => x.BlogId,
                        principalTable: "Blogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogDislikes_Users_UserId",
                        column: x => x.UserId,
